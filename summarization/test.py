...
if __name__ == "__main__":
    ...
    best_model = T5ForConditionalGeneration.from_pretrained(config.model_checkpoint)
    best_model = best_model.to(device)

    logger.info("Begin Prediction")
    test_result = predict_summary(best_model, test_dl, num_batch = config.num_batch)
